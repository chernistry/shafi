...
- **Unmatched**: 0
- **Overall Grounding F-beta (beta=2.5)**: 0.4661
- **Weighted Grounding F-beta**: 0.494 (high=1.0, medium=0.5, low=0.25)
- **Trusted-only Grounding F-beta**: 0.5193 (high confidence only)
- **Exact Match Rate (deterministic types)**: 0.7571 (53/70)
- **Trusted Exact Match Rate**: 0.7424
- **Trusted Regressions**: 17
...
| free_text | 0.4673 | 30 | - | - |
| name | 0.5079 | 14 | 0.7857 | 14 |
| names | 0.7890 | 3 | 1.0000 | 3 |
| number | 0.5223 | 17 | 0.8235 | 17 |

## By Confidence Tier

| Confidence | F-beta (mean) | F-beta (n) | Exact Match | Exact (n) |
|------------|--------------|------------|-------------|-----------|
| high | 0.5193 | 81 | 0.7424 | 66 |
...
| compare | 0.3735 | 30 | 0.8077 | 26 |
| enactment | 0.3630 | 13 | 0.5000 | 6 |
| free_text_other | 0.4315 | 11 | - | - |
| names | 0.7065 | 12 | 0.8333 | 12 |
| number | 0.4522 | 13 | 0.7692 | 13 |
...
| acd3200d | free_text | 0.0000 | 0.00 | 0.00 | 2 | 3 | None |
