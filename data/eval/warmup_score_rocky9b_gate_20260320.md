...
- **Unmatched**: 0
- **Overall Grounding F-beta (beta=2.5)**: 0.4461
- **Weighted Grounding F-beta**: 0.4716 (high=1.0, medium=0.5, low=0.25)
- **Trusted-only Grounding F-beta**: 0.4946 (high confidence only)
...
|------|--------------|------------|-------------|-----------|
| boolean | 0.3496 | 35 | 0.6857 | 35 |
| date | 1.0000 | 1 | 1.0000 | 1 |
| free_text | 0.4673 | 30 | - | - |
| name | 0.5794 | 14 | 0.7857 | 14 |
...
| boolean | 0.2505 | 11 | 0.7273 | 11 |
| compare | 0.4402 | 30 | 0.8077 | 26 |
