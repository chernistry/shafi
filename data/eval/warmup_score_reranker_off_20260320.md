...
- **Unmatched**: 0
- **Overall Grounding F-beta (beta=2.5)**: 0.2824
- **Weighted Grounding F-beta**: 0.3078 (high=1.0, medium=0.5, low=0.25)
- **Trusted-only Grounding F-beta**: 0.3333 (high confidence only)
- **Exact Match Rate (deterministic types)**: 0.7571 (53/70)
- **Trusted Exact Match Rate**: 0.7742
- **Trusted Regressions**: 14

## By Answer Type

| Type | F-beta (mean) | F-beta (n) | Exact Match | Exact (n) |
|------|--------------|------------|-------------|-----------|
| boolean | 0.2347 | 35 | 0.6857 | 35 |
| date | 1.0000 | 1 | 1.0000 | 1 |
| free_text | 0.2720 | 30 | - | - |
| name | 0.1786 | 14 | 0.7857 | 14 |
| names | 0.7890 | 3 | 1.0000 | 3 |
| number | 0.3529 | 17 | 0.8235 | 17 |

## By Confidence Tier

| Confidence | F-beta (mean) | F-beta (n) | Exact Match | Exact (n) |
|------------|--------------|------------|-------------|-----------|
| high | 0.3333 | 71 | 0.7742 | 62 |
| low | 0.1622 | 10 | 0.2500 | 4 |
| medium | 0.1555 | 19 | 1.0000 | 4 |

## By Question Family

| Family | F-beta (mean) | F-beta (n) | Exact Match | Exact (n) |
|--------|--------------|------------|-------------|-----------|
| administration | 0.1667 | 4 | 0.0000 | 1 |
| boolean | 0.0455 | 11 | 0.7273 | 11 |
| compare | 0.3404 | 30 | 0.8077 | 26 |
| enactment | 0.2141 | 13 | 0.5000 | 6 |
| free_text_other | 0.5156 | 11 | - | - |
| names | 0.3223 | 12 | 0.8333 | 12 |
| number | 0.3077 | 13 | 0.7692 | 13 |
| outcome_costs | 0.2685 | 2 | 1.0000 | 1 |
| unsupported_trap | 0.0000 | 4 | - | - |
...
| 6351cfe2 | free_text | 0.0000 | 0.00 | 0.00 | 3 | 4 | None |
| b4d8c1cc | free_text | 0.0000 | 0.00 | 0.00 | 2 | 2 | None |
| 5d8fd833 | free_text | 0.0000 | 0.00 | 0.00 | 2 | 2 | None |
| 54103603 | free_text | 0.0000 | 0.00 | 0.00 | 2 | 2 | None |
| 115a9bca | free_text | 0.0000 | 0.00 | 0.00 | 3 | 6 | None |
| 2180c758 | free_text | 0.0000 | 0.00 | 0.00 | 2 | 3 | None |
| 1107e284 | free_text | 0.0000 | 0.00 | 0.00 | 1 | 2 | None |
| f35f42eb | free_text | 0.0000 | 0.00 | 0.00 | 2 | 1 | None |
...
| f2ea23e9 | number | 3 | 6 |
| d6eb4a64 | boolean | False | Yes |
| cd0c8f36 | name | gross remuneration | gross and net |
| af8d4690 | boolean | False | null |
