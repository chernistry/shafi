...
- **Unmatched**: 0
- **Overall Grounding F-beta (beta=2.5)**: 0.367
- **Weighted Grounding F-beta**: 0.3927 (high=1.0, medium=0.5, low=0.25)
- **Trusted-only Grounding F-beta**: 0.4177 (high confidence only)
...
|------|--------------|------------|-------------|-----------|
| boolean | 0.2595 | 35 | 0.7143 | 35 |
| date | 1.0000 | 1 | 1.0000 | 1 |
| free_text | 0.3768 | 30 | - | - |
| name | 0.4034 | 14 | 0.8571 | 14 |
| names | 1.0000 | 3 | 1.0000 | 3 |
| number | 0.3919 | 17 | 0.8235 | 17 |

## By Confidence Tier

| Confidence | F-beta (mean) | F-beta (n) | Exact Match | Exact (n) |
|------------|--------------|------------|-------------|-----------|
| high | 0.4178 | 81 | 0.7727 | 66 |
...
| 4ce050c0 | free_text | 0.0000 | 0.00 | 0.00 | 2 | 2 | None |
