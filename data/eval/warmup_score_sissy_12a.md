...
- **Unmatched**: 0
- **Overall Grounding F-beta (beta=2.5)**: 0.43
- **Weighted Grounding F-beta**: 0.4537 (high=1.0, medium=0.5, low=0.25)
- **Trusted-only Grounding F-beta**: 0.4751 (high confidence only)
...
|------|--------------|------------|-------------|-----------|
| boolean | 0.4042 | 35 | 0.7143 | 35 |
| date | 1.0000 | 1 | 1.0000 | 1 |
| free_text | 0.4661 | 30 | - | - |
| name | 0.3214 | 14 | 0.7143 | 14 |
...
|------------|--------------|------------|-------------|-----------|
| high | 0.4751 | 81 | 0.7424 | 66 |
| low | 0.2000 | 5 | 1.0000 | 1 |
| medium | 0.2508 | 14 | 1.0000 | 3 |
...
| compare | 0.5038 | 30 | 0.7692 | 26 |
| enactment | 0.2861 | 13 | 0.5000 | 6 |
| free_text_other | 0.4281 | 11 | - | - |
