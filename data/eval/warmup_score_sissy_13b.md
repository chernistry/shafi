...
- **Unmatched**: 0
- **Overall Grounding F-beta (beta=2.5)**: 0.419
- **Weighted Grounding F-beta**: 0.4412 (high=1.0, medium=0.5, low=0.25)
- **Trusted-only Grounding F-beta**: 0.4611 (high confidence only)
