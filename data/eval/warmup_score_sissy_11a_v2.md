...
- **Unmatched**: 0
- **Overall Grounding F-beta (beta=2.5)**: 0.4262
- **Weighted Grounding F-beta**: 0.4493 (high=1.0, medium=0.5, low=0.25)
- **Trusted-only Grounding F-beta**: 0.4701 (high confidence only)
