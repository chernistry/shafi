...
A staged LangGraph pipeline that answers 900 legal questions over 300 DIFC documents with page-level retrieval, anchor-based filtering, and faithfulness guardrails. Developed over a 12-day competition sprint (March 10--22, 2026), culminating in a multi-agent coordination phase where several AI agents worked in parallel on the final push.
...
| Final placement | 38th of 80 scoring teams (0.480 private-set score) |
...
[AGPL-3.0](LICENSE). Commercial licensing available on request: [alex@alexchernysh.com](mailto:alex@alexchernysh.com).
