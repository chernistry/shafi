...
from rag_challenge.core.field_lookup import FieldAnswer, FieldLookupTable, FieldType
    ...
    def from_paths(
        ...
        *,
        ...
        entity_reg = (
            ...
            if alias_registry_path and alias_registry_path.strip() and Path(alias_registry_path).is_file()
            else EntityRegistry()
        )
        return cls(
