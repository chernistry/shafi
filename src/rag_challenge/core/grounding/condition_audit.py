...
from rag_challenge.core.grounding.authority_priors import matches_field_family
...
def _page_supports_slot(*, slot: str, page: RetrievedPage) -> bool:
    ...
    if slot == "party_title":
        return page.has_caption_block or page.page_role == "title_cover" or page.page_template_family in {
            "caption_header",
            "title_cover",
            "official_primary",
        }
