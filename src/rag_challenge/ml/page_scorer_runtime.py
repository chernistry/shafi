...
from rag_challenge.ml.training_scaffold import SUPPORTED_FEATURE_POLICIES
    ...
    *,
    ...
    return {
        ...
        "same_page_num_competitors": sum(
            1 for p in request.page_candidates
            if p.page_num == page.page_num and p.doc_id != page.doc_id
        ),
