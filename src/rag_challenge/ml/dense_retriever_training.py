    ...
    def train(
        ...
        *,
        ...
        filtered = {
            ...
            if abs(weight) > config.min_token_weight
        }
...
def _evaluate_cases(*, artifact: DenseRetrieverArtifact, eval_cases: Sequence[RetrievalEvalCase]) -> RetrievalMetrics:
    ...
    for case in eval_cases:
        ranked_page_ids = _rank_pages(question=case.question, candidate_page_texts=case.candidate_page_texts, artifact=artifact)
