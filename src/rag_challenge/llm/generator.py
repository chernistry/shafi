...
class RAGGenerator:
    ...
    def build_prompt(
        ...
        *,
        ...
        enable_interleaved = bool(
            getattr(self._pipeline_settings, "enable_interleaved_citations", False)
        )
    ...
    def build_structured_free_text_answer(
        ...
        *,
        ...
        if any(term in q for term in ("penalt", " fine", "fine ")) and "define" not in q and "refine" not in q and not self._is_broad_enumeration_question(question):
