...
class ApplicabilityGraph(BaseModel):
    ...
    def get_amendments(self, law_id: str) -> list[ApplicabilityEdge]:
        ...
        return [edge for edge in self.edges if edge.target_doc_id == law_id and edge.edge_type is ApplicabilityEdgeType.AMENDS]
...
if TYPE_CHECKING:
    from rag_challenge.models.legal_objects import LawObject
