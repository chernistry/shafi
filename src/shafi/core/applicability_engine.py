...
from shafi.core.query_contract import PredicateType, QueryContract, TimeScopeType
...
from shafi.models.legal_objects import CorpusRegistry, LawObject
...
class ApplicabilityEngine:
    ...
    def answer_temporal_status(self, law_id: str, contract: QueryContract) -> TemporalResult | None:
        ...
        end_date = (
            self._parse_date(str(end_edge.effective_date)) if end_edge is not None and end_edge.effective_date else None
        )
