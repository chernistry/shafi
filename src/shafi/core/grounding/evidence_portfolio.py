...
from shafi.core.grounding.condition_audit import audit_candidate_pages
...
def build_law_bundle_candidate(
    *,
    ...
    matching_pages = [
        page for page in ordered_pages if _page_law_bundle_match_score(query_bundle, page) > 0.0 and page.page_id
    ]
