...
from shafi.core.grounding.authority_priors import authority_signal_score
from shafi.core.grounding.law_family_graph import build_query_law_family_bundle
from shafi.core.rerank_instructions import build_rerank_instruction
from shafi.models.schemas import ScopeMode

if TYPE_CHECKING:
    from collections.abc import Sequence

    from shafi.core.grounding.condition_audit import ConditionAuditResult
...
def _law_family_is_ambiguous(*, query: str, ordered_pages: Sequence[RetrievedPage]) -> bool:
    ...
    if not query_bundle.exact_keys:
        return False
    families = {page.canonical_law_family for page in ordered_pages[:3] if str(page.canonical_law_family).strip()}
