...
from shafi.ingestion.external_segment_payload import (
...
def load_shadow_benchmark_cases(path: Path) -> list[ExternalSegmentShadowCase]:
    ...
    for item in records:
        ...
        if isinstance(case, dict):
            ...
            baseline_page_ids = _coerce_str_list(item_obj.get("retrieved_page_ids")) or _coerce_str_list(
                telemetry_obj.get("retrieved_page_ids")
            )
