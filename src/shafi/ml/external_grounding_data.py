        ...
        for paragraph in _coerce_list(example.get("paragraphs")):
            ...
            for qa in _coerce_list(paragraph.get("qas")):
                if not isinstance(qa, dict):
                    continue
                answers = [answer for answer in _coerce_list(qa.get("answers")) if isinstance(answer, dict)]
                yield {
                    "title": title,
                    "context": context,
                    ...
                    "answers": {
                        ...
                        "text": [
                            _coerce_str(answer.get("text")) for answer in answers if _coerce_str(answer.get("text"))
                        ],
                    },
                }
