...
class HardNegativeMiner:
    ...
    def mine_alias_confusable(
        ...
        *,
        ...
        return self._rank_candidates(
            query=query, page_ids=page_ids, strategy=NegativeStrategy.ALIAS_CONFUSABLE, bonus=0.25
        )
    ...
    def mine_lexical_near_miss(
        ...
        *,
        ...
        return self._rank_candidates(
            query=query, page_ids=page_ids, strategy=NegativeStrategy.LEXICAL_NEAR_MISS, bonus=0.0
        )
