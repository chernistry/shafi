...
if TYPE_CHECKING:
    from shafi.ingestion.external_segment_payload import ExternalSegmentRecord
...
_ENACTMENT_NOTICE_RE = re.compile(
    r"\b(?:enactment notice|commencement|comes into force|effective date)\b", re.IGNORECASE
)
