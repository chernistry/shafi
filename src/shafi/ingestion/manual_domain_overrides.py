...
from shafi.models.legal_objects import CaseObject, CaseParty, LawObject, OrderObject, PracticeDirectionObject

if TYPE_CHECKING:
    from collections.abc import Sequence

    from shafi.ingestion.corpus_compiler import CompiledLegalObject
...
def _all_manual_domain_overrides() -> dict[str, ManualDomainOverride]:
    ...
    from shafi.ingestion.manual_case_overrides import MANUAL_CASE_OVERRIDES
    from shafi.ingestion.manual_law_overrides import MANUAL_LAW_OVERRIDES
