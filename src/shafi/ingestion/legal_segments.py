...
from shafi.models import Chunk, DocType, LegalSegment, SegmentType

if TYPE_CHECKING:
    from shafi.models.legal_objects import BaseLegalObject, CorpusRegistry
    from shafi.models.schemas import ParsedDocument
...
def _is_contents_like_page(text: str) -> bool:
    ...
    heading_like_lines = sum(
        1 for raw_line in text.splitlines() if raw_line.strip() and _HEADING_RE.match(_normalize_line(raw_line))
    )
    ...
    def compile_segments(
        ...
        for segment in segments:
            ...
            if segment.segment_type is SegmentType.CHAPTER:
                ...
                parent_segment_id = parent_stack.get(SegmentType.CHAPTER, "") or parent_stack.get(SegmentType.PART, "")
