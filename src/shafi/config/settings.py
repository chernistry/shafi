...
class LLMSettings(BaseSettings):
    ...
    free_text_simple_model: str = (
        ""  # If set, overrides simple_model for free_text SIMPLE queries; defaults to simple_model
    )
...
class IngestionSettings(BaseSettings):
    ...
    manifest_filename: str = ".shafi_ingestion_manifest.json"
...
class PlatformSettings(BaseSettings):
    ...
    archive_allowlist_path: str = "src/shafi/submission/archive_allowlist.json"
