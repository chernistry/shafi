...
ROUTER_DIR="$ARTIFACT_ROOT/models/grounding_router/v1_full"
SCORER_DIR="$ARTIFACT_ROOT/models/page_scorer/v1_full"
EVAL_PATH="$ARTIFACT_ROOT/models/grounding_eval/v1_full_metrics.json"
