...
from rag_challenge.ml.training_scaffold import load_grounding_rows, split_rows_by_holdout_doc_family
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--legal-ner-dir",
        type=Path,
        default=Path("/Users/sasha/IdeaProjects/personal_projects/rag_challenge/data/external/Legal NER Dataset"),
