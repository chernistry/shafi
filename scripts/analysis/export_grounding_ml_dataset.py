...
from shafi.ml.grounding_dataset import export_grounding_ml_dataset
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        default=_default_path(
            ...
            "/Users/sasha/IdeaProjects/.codex-worktrees/shafi-grounding-sidecar-recovery/platform_runs/warmup/raw_results_v4_grounding_sidecar_r1_legacy.json",
    ...
    parser.add_argument(
        ...
        default=_default_path(
            ...
            "/Users/sasha/IdeaProjects/.codex-worktrees/shafi-grounding-sidecar-recovery/platform_runs/warmup/raw_results_v4_grounding_sidecar_r1_sidecar.json",
            str(repo_root / "platform_runs" / "warmup" / "raw_results_v4_grounding_sidecar.json"),
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=Path,
        default=_default_path(
            "/Users/sasha/IdeaProjects/.codex-worktrees/shafi-grounding-sidecar-recovery/.sdd/researches/golden_label_self_audit_2026-03-18/matched_suspect_labels.json",
