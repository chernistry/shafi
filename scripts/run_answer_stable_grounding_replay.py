...
def _render_markdown(payload: JsonDict) -> str:
    ...
    lines = [
        ...
        "## Reviewed all_100",
        "",
        f"- baseline_overall_grounding_f_beta: `{baseline_all['overall_grounding_f_beta']}`",
        f"- candidate_overall_grounding_f_beta: `{candidate_all['overall_grounding_f_beta']}`",
        f"- baseline_trusted_grounding_f_beta: `{baseline_all['trusted_grounding_f_beta']}`",
        f"- candidate_trusted_grounding_f_beta: `{candidate_all['trusted_grounding_f_beta']}`",
        f"- family_delta: `{reviewed_all.get('family_delta')}`",
        "",
        "## Reviewed high_confidence_81",
        "",
        f"- baseline_overall_grounding_f_beta: `{baseline_high['overall_grounding_f_beta']}`",
        f"- candidate_overall_grounding_f_beta: `{candidate_high['overall_grounding_f_beta']}`",
        f"- baseline_trusted_grounding_f_beta: `{baseline_high['trusted_grounding_f_beta']}`",
        f"- candidate_trusted_grounding_f_beta: `{candidate_high['trusted_grounding_f_beta']}`",
