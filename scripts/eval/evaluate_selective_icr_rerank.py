...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "~/projects/shafi/.sdd/researches/explicit_profile_baseline_2026-03-19/main_vs_explicit_profile/raw_results_answer_stable_replay.json"
        ),
    ...
    parser.add_argument(
        "--reviewed-all",
        type=Path,
        default=Path("~/projects/shafi/.sdd/golden/reviewed/reviewed_all_100.json"),
        help="Path to the reviewed all_100 gold slice.",
    )
    parser.add_argument(
        "--reviewed-high",
        type=Path,
        default=Path("~/projects/shafi/.sdd/golden/reviewed/reviewed_high_confidence_81.json"),
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "~/projects/shafi/.sdd/researches/1065_selective_icr_local_rerank_and_provider_exit_r1_2026-03-19"
        ),
