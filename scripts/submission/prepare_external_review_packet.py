...
PACKET_FILES: tuple[PacketFile, ...] = (
    ...
    PacketFile(PROJECT_ROOT / "src" / "rag_challenge" / "core" / "pipeline.py", "pipeline.py"),
    PacketFile(PROJECT_ROOT / "src" / "rag_challenge" / "core" / "retriever.py", "retriever.py"),
    PacketFile(PROJECT_ROOT / "src" / "rag_challenge" / "ingestion" / "parser.py", "parser.py"),
    PacketFile(PROJECT_ROOT / "src" / "rag_challenge" / "ingestion" / "chunker.py", "chunker.py"),
    PacketFile(PROJECT_ROOT / "src" / "rag_challenge" / "core" / "strict_answerer.py", "strict_answerer.py"),
)
