...
from rag_challenge.core.pipeline.retrieval_primitives import (
...
def test_augment_query_for_sparse_retrieval_adds_drafting_variants_for_provisions() -> None:
    boosted = augment_query_for_sparse_retrieval(
        "Please apply Article 11(1)(a), Section 4(2), Schedule 1 and Part IV."
    )
