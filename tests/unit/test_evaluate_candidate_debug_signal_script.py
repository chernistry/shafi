...
async def test_async_main_writes_attribution_falsifier_when_benchmark_present(
        ...
        [
            {
                ...
                "telemetry": {
                    "ttft_ms": 10,
                    "used_page_ids": ["doc_bad_1", "doc_good_2"],
                    "context_chunk_ids": [],
                    "cited_chunk_ids": [],
                },
            },
    ...
    monkeypatch.setattr(
        ...
        lambda: type(
            ...
            {
                "judge": type(
                    "Judge", (), {"enabled": False, "sources_max_chars_per_page": 20000, "sources_max_pages": 12}
                )()
            },
        )(),
    )
    ...
    payload = json.loads(
        (out_dir / "candidate_debug_compare_candidate_y_vs_baseline_x.json").read_text(encoding="utf-8")
    )
