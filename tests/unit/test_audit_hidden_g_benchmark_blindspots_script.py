...
def test_build_blindspots_surfaces_missing_anchor_case_not_in_benchmark(tmp_path: Path) -> None:
    ...
    _write_raw_results(
        raw_results,
        [{"case": {"case_id": "qid-1"}, "telemetry": {"used_page_ids": ["otherdoc_4"], "context_page_ids": [], "retrieved_page_ids": []}}],
    )
...
def test_build_blindspots_marks_multi_doc_and_same_doc_family_tags(tmp_path: Path) -> None:
    ...
    _write_raw_results(
        raw_results,
        [{"case": {"case_id": "qid-1"}, "telemetry": {"used_page_ids": ["doc_1_3"], "context_page_ids": [], "retrieved_page_ids": []}}],
    )
