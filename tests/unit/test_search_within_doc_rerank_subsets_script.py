                ...
                "answers": [
                    {
                        ...
                        "answer": "A",
                        "telemetry": {
                            "retrieval": {"retrieved_chunk_pages": [{"doc_id": "doc1", "page_numbers": [2]}]}
                        },
                    },
                    {
                        "question_id": "q2",
                        "answer": "B",
                        "telemetry": {
                            "retrieval": {"retrieved_chunk_pages": [{"doc_id": "doc2", "page_numbers": [4]}]}
                        },
                    },
                ]
            }
            ...
            [
                {
                    ...
                    "answer_text": "A",
                    "telemetry": {
                        "used_page_ids": ["doc1_2"],
                        "context_page_ids": ["doc1_2"],
                        "retrieved_page_ids": ["doc1_2"],
                    },
                },
                {
                    "case": {"case_id": "q2"},
                    "answer_text": "B",
                    "telemetry": {
                        "used_page_ids": ["doc2_4"],
                        "context_page_ids": ["doc2_4"],
                        "retrieved_page_ids": ["doc2_4"],
                    },
                },
            ]
        ),
        ...
        json.dumps(
            {
                "records": [
                    ...
                    },
                    {
                        ...
                        "manual_verdict": "correct",
                        "failure_class": "support_undercoverage",
                        "minimal_required_support_pages": ["doc2_4"],
                    },
                ]
            }
        ),
