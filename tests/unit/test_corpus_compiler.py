...
FIXTURE_DIR = Path("/Users/sasha/IdeaProjects/personal_projects/shafi/tests/fixtures/docs")
...
def test_compile_documents_is_idempotent_for_fixture_pack() -> None:
    compiler = CorpusCompiler()
    docs = [
        _parse_fixture("limitation_act.txt"),
        _parse_fixture("smith_v_jones.txt"),
        _parse_fixture("sample_contract.txt"),
    ]
