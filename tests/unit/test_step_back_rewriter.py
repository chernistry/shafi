...
async def test_step_back_returns_original_on_api_failure() -> None:
    ...
    with patch("shafi.core.step_back_rewriter.AsyncOpenAI") as mock_cls:
...
async def test_step_back_returns_rewritten_on_success() -> None:
    ...
    with patch("shafi.core.step_back_rewriter.AsyncOpenAI") as mock_cls:
        ...
        result = await rewrite_step_back("What does Article 5(2)(a) say about overtime?", api_key="test-key")
