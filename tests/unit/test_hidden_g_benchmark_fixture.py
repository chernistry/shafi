...
def test_hidden_g_benchmark_seed_fixture_has_expected_shape() -> None:
    ...
    assert any(
        len({page for item in case.items for slot in item.slots for page in slot.gold_page_ids}) >= 2 for case in cases
    )
...
def test_hidden_g_benchmark_keeps_scaffold_backed_anchor_cases() -> None:
    ...
    expected = {
        "802d12a65530cd728da4c2f4430275488285ced247123431a905f8d525e80ede": [
            "58eae81bf668e7f6c58619f419a49b5e35e2e5c9c7475475ace28ec562580545_2"
        ],
        ...
        "5d271fced60d88e008a69adc2da21de427906206bfb49f5554a3bf1dd6f72772": [
            "fbdd7f9dd299d83b1f398778da2e6765dfaaed62005667264734a1f76ec09071_1"
        ],
        "ff1b357588e9b5881ec9b1558ede2892e7cbf42a6787a1cbb922b45318f66778": [
            "ff746f7b583490a80ba104361c0a82a1ebbf7ed9097cd03dc49d744cb5057761_1"
        ],
        "922dcd5ae0d2420ec5577ed8094f593124f7b69f7e61b12c24ad46410114e8ae": [
            "4e387152960c1029b3711cacb05b287b13c977bc61f2558059a62b7b427a62eb_1"
        ],
