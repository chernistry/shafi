    ...
    *,
    ...
    return GroundingMlRow(
        ...
        support_fact_features=SupportFactFeatureRecord(
            doc_ref_count=1, target_page_roles_count=1, explicit_anchor_count=1
        ),
...
def test_page_training_examples_prefer_reviewed_labels() -> None:
    ...
    # r2 includes legacy_cited_rank as a recall-oriented signal
    assert "legacy_cited_rank" in positive.features
