...
from shafi.core.pipeline.support_formatting import coerce_strict_type_format
...
def test_boolean_word_boundary_yes() -> None:
    ...
    _answer, ok = coerce_strict_type_format(_StubPipeline(), "It was resolved yesterday", "boolean", [])
...
def test_boolean_word_boundary_no() -> None:
    ...
    _answer, ok = coerce_strict_type_format(_StubPipeline(), "This is a notable achievement", "boolean", [])
