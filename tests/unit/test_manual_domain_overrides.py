...
from shafi.ingestion.canonical_entities import build_law_aliases
from shafi.ingestion.corpus_compiler import CorpusCompiler
from shafi.ingestion.manual_domain_overrides import (
...
def test_corpus_compiler_applies_manual_override_and_refreshes_field_pages(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "shafi.ingestion.corpus_compiler.get_manual_domain_override",
