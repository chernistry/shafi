...
from shafi.ml.page_scorer_runtime import RuntimePageScorer, RuntimePageScoringRequest
from shafi.models import RetrievedPage
...
def _make_request() -> RuntimePageScoringRequest:
    ...
    return RuntimePageScoringRequest(
        ...
        page_candidates=[
            RetrievedPage(
                page_id="doc-gp-law_1",
                doc_id="doc-gp-law",
                page_num=1,
                score=0.6,
                page_text="GENERAL PARTNERSHIP LAW Enacted by decree",
            ),
            RetrievedPage(
                page_id="doc-gp-law_2",
                doc_id="doc-gp-law",
                page_num=2,
                score=0.65,
                page_text="Table of Contents Part I Preliminary",
            ),
            RetrievedPage(
                page_id="doc-gp-law_3",
                doc_id="doc-gp-law",
                page_num=3,
                score=0.7,
                page_text="Article 1 definitions means",
            ),
            RetrievedPage(
                page_id="doc-gp-law_4",
                doc_id="doc-gp-law",
                page_num=4,
                score=0.75,
                page_text="Article 14 Assignment of Partnership Interest (1) Subject to this Law (2)(b) A partner may assign",
            ),
            RetrievedPage(
                page_id="doc-gp-law_5",
                doc_id="doc-gp-law",
                page_num=5,
                score=0.72,
                page_text="Article 15 Dissolution of Partnership shall must",
            ),
            RetrievedPage(
                page_id="doc-gp-law_6",
                doc_id="doc-gp-law",
                page_num=6,
                score=0.68,
                page_text="Article 16 Distribution of assets pursuant to",
            ),
            RetrievedPage(
                page_id="doc-gp-law_7",
                doc_id="doc-gp-law",
                page_num=7,
                score=0.64,
                page_text="Article 20 Liability of partners notwithstanding",
            ),
            RetrievedPage(
                page_id="doc-gp-law_8",
                doc_id="doc-gp-law",
                page_num=8,
                score=0.62,
                page_text="Schedule 1 Interpretation provisions defined",
            ),
            RetrievedPage(
                page_id="doc-gp-law_9",
                doc_id="doc-gp-law",
                page_num=9,
                score=0.58,
                page_text="Schedule 2 Forms and notices",
            ),
            RetrievedPage(
                page_id="doc-gp-law_10",
                doc_id="doc-gp-law",
                page_num=10,
                score=0.55,
                page_text="Amendments and transitional provisions",
            ),
        ],
...
def test_lgbm_produces_different_ranking_than_logistic() -> None:
    ...
    assert lgbm_result.ranked_page_ids != logistic_result.ranked_page_ids, (
        "LightGBM and logistic produced identical rankings — either models are equivalent or test data is degenerate"
    )
