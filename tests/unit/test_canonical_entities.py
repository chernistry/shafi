...
from rag_challenge.ingestion.canonical_entities import (
    CanonicalEntityType,
    EntityAliasResolver,
)
...
def test_entity_registry_enriches_query_with_canonical_ids(tmp_path) -> None:
    ...
    enriched = registry.enrich_query(
        "Did DFSA act under the Companies Law in CFI 001/2024 before Cooke J?"
    )
