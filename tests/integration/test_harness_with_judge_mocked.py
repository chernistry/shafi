...
from shafi.eval import harness as harness_mod
from shafi.eval.judge import JudgeOutcome, JudgeResult, JudgeScores
...
@pytest.mark.asyncio
async def test_harness_flags_unjustified_and_justified_zero_support(tmp_path, monkeypatch: pytest.MonkeyPatch) -> None:
    golden = tmp_path / "golden.json"
    golden.write_text(
        json.dumps(
            [
